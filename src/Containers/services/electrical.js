...
class Electrical extends Component {
    constructor(props) {
        ...
        this.state = {
            list: [
                { name: 'Wiring & Switching', link: '#electrical', image: require('../../Images/wiring.svg') },
                { name: 'TV', link: '#tv', image: require('../../Images/television.svg') },
                { name: 'Refrigerator', link: '#Refrigerator', image: require('../../Images/refrigerator.svg') },
                { name: 'Fan&Cooler', link: '#fan', image: require('../../Images/cooler.svg') },
                { name: 'Air Conditioning', link: '#Air', image: require('../../Images/air-conditioning.svg') },
                { name: 'Mixer&Iron', link: '#Mixer', image: require('../../Images/blender.svg') },
                { name: 'Micro Oven&Electrics', link: '#Micro', image: require('../../Images/microwave-oven.svg') },
                { name: 'Others', link: '#Others', image: require('../../Images/music-player.svg') }
            ],
            popUp: [
                { name:'Wiring & Switching',   service: 'Wiring & Switching Service',   link: '#electrical',  pop:'electrical'  , image: require('../../Images/wiring.svg') },
                { name:'TV',                   service: 'TV Service',                   link: '#tv',          pop:'tv'          ,image: require('../../Images/television.svg')},
                { name:'Refrigerator',         service: 'Refrigerator Service',         link: '#Refrigerator',pop:'Refrigerator',image: require('../../Images/refrigerator.svg')},
                { name:'Fan&Cooler',           service: 'Fan&Cooler Service',           link: '#fan',          pop:'fan'          ,image: require('../../Images/cooler.svg')},
                { name:'Air Conditioning',     service: 'Air Conditioning Service',     link: '#Air',          pop:'Air'          ,image: require('../../Images/air-conditioning.svg')},
                { name:'Mixer&Iron',           service: 'Mixer&Iron Service',           link: '#Mixer',        pop:'Mixer'          ,image: require('../../Images/blender.svg')},
                { name:'Micro Oven&Electrics', service: 'Micro Oven&Electrics Service', link: '#Micro',        pop:'Micro'          ,image: require('../../Images/microwave-oven.svg')},
                { name:'Others',               service: 'Others Services',              link: '#Others',       pop:'Others'          ,image: require('../../Images/music-player.svg')},
            ]
        };
    }
    render() {
        return (
            <div>
                <Header />
                <div className="container-fluid electical-section mt-2">
                    <ul className="breadcrumb theme-bg-color justify-content-end">
                        <li className="breadcrumb-item"><Link to="/home">Home</Link></li>
                        <li className="breadcrumb-item"><Link to="/dashboard">Services</Link></li>
