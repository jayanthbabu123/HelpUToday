...
class Health extends Component {
    ...
    componentDidMount() {
        Axios.get('/main_cat_array/5/sub_cat_array_health.json')
            .then(response => {
            ...
            <div>
                ...
                <div className="container-fluid services-section mt-2">
                    <ul className="breadcrumb theme-bg-color justify-content-end">
                        ...
                        <li className="breadcrumb-item active">Health & Personal</li>
                    </ul>
                    <div className="container">
                        <h2 className="text-center">Health & Personal</h2>
                        <h4 className="theme-blue text-center">All Health & Personal services under one umbrella</h4>
                                    ...
                                    <div className="col-md-3" key={index} onClick={() => this.openModal(item)}>
                                        <div className="card card-body shadow-sm mb-4 animated fadeIn">
                                            <div className="text-center">
                                                <span><img src={require(`../../Images/health-personal/${item.sub_cat_icon}`)} width="50" height="50" className="mt-4" /></span>
...
export default connect(mapSatetoProps)(Health);
